...
public class MaxHeap<T extends Comparable<? super T>> {
    ...
    /**
    * Helper method that checks array capacity and resizes, if necessary.
    */
    ...
    /**
     * Helper method that conducts a swap of data between two indices.
     *
     * @param index1 First index to be swapped in array
     * @param index2 Second index to be swapped in array
     */
    ...
    /**
     * Helper method that conducts the down heap algorithm.
     *
    ...
    private void downHeap(int curr) {
        ...
        if (left <= size && backingArray[max].compareTo(backingArray[left]) < 0) {
            max = left;
        }
        if (right <= size && backingArray[max].compareTo(backingArray[right]) < 0) {
            max = right;
        }
        if (curr != max) {
            swap(curr, max);
    ...
    /**
     * Helper method that conducts the up heap algorithm.
     *
     * @param curr Current index in tree
     */
